...
document.addEventListener('mouseup', function(e) {
  ...
  if (selectedText.length > 0) {
    showSelected(e.clientX, e.clientY, selectedText);
  }
...
function showSelected(x, y, selectedText) {
  // Nuke previous showSelected
  var prevShowSelected = document.querySelector('#showSelected');
  if (prevShowSelected) {
